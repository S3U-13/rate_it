...
@section('title')
   เพิ่มองค์ประกอบทั่วไป
@endsection

@section('content')
    <div class="p-4 sm:ml-64">
        <div class=" mt-14 max-w-3xl mx-auto">
            <h1 class="pt-6 text-2xl">เพิ่มองค์ประกอบทั่วไป</h1>
            <div class="bg-white rounded-lg shadow-xl mt-6 max-w-3xl mx-auto border">

                <form action="{{ route('admin.evaluation_components.store_general') }}" method="POST" class="px-6 py-8">
                    @csrf
                    <div class="grid grid-cols-1 gap-6">
                        <div>
                            ...
                            <input type="text" name="component_name" id="component_name" placeholder="กรอกหัวข้อองค์ประกอบการประเมิน"
