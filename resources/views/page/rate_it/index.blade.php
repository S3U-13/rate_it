        ...
        <div class="bg-white shadow-md rounded-lg overflow-hidden">
            <div class="bg-[#138f3c] text-white text-center py-3">
                @if ($evaluationRound == 1)
                    <h5 class="text-lg font-semibold">📋 รายการบุคลากรสำหรับการประเมิน รอบที่ ๑ ประจำปี {{ $thaiNumbers }}
                    </h5>
                @elseif($evaluationRound == 2)
                    <h5 class="text-lg font-semibold">📋 รายการบุคลากรสำหรับการประเมิน รอบที่ ๒ ประจำปี {{ $thaiNumbers }}
                    </h5>
                @endif
            </div>
                ...
                <table class="min-w-full border border-white">
                    <thead class="bg-[#138f3c] text-white text-center">
                        <tr>
                            ...
                            <th class="px-4 py-2 w-2/6 border">ชื่อ-นามสกุล</th>
                    ...
                    <tbody class="text-center">
                        ...
                        @elseif ($hasCompletedEvaluation)
                            @if ($evaluationRound == 1)
                                <tr>
                                    <td colspan="4" class="px-4 py-6 border border-[#006622]">
                                ...
                                <tr class="border border=[#006622] hover:bg-gray-100">
                                    ...
                                    <td class="px-4 py-2 border border-[#006622]">
                                        <a href="{{ route('page.rate_it.create', $item->id) }}"
                                            ...
                                            <i class="bi bi-pencil-square"></i> ประเมิน
                                        </a>
                                    </td>
                                </tr>
                            @endforeach
