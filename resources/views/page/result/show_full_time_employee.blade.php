    ...
    <div class="w-full max-w-screen-lg h-full border border-gray-300 mx-auto rounded-lg overflow-hidden shadow-2xl">
        ...
        <div class="pl-[3rem] pr-[2rem]">
            <div class="px-4 md:px-16 lg:px-24 xl:px-32">
                <h1 class="font-bold mt-6 text-xl text-left md:text-left">เเบบสรุปการประเมินการปฏิบัติงานของลูกจ้างประจำ</h1>
        ...
        <div class="pl-[4rem] pr-[3rem]">
            ...
            @php
                $current_responsibilities = json_decode($summarize_01->first()->current_responsibilities ?? '[]', true);
            @endphp
        ...
        <div class="pl-[4rem] pr-[3rem]">
            ...
            <div class="mt-2 border rounded-lg p-2">
                ...
                <p class="w-full rounded-lg mt-2 h-30">{{ $summarize_02->first()->evaluator_comment ?? 'ยังไม่มีข้อมูล' }}
                </p>
            </div>
