...
@section('content')
    <div
        class="p-2 rounded-lg shadow-xl mx-auto border border-[#006622] w-[320px] h-[440px] overflow-hidden sm:w-[360px] sm:h-[560px] md:w-[500px] md:h-[720px] md:mt-10">
        <form action="{{ route('page.profile.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <input class="w-[220px] ml-[40px] mt-[10px] sm:w-[320px] sm:mt-[10px] sm:ml-[10px] md:mt-[10px] md:ml-[40px] md:w-[400px]" type="file"
                name="user_pic" id="user_pic" onchange="previewImage(event)">
            <div
