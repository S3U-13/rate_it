...
@section('content')
    <div
        class="p-2 rounded-lg shadow-xl mx-auto border border-[#006622] w-[320px] h-[440px] overflow-hidden sm:w-[360px]
    sm:h-[560px] md:w-[500px] md:h-[720px] md:mt-10">
        <form action="{{ route('page.profile.update', $profile->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
