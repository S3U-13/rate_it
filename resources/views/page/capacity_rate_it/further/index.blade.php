...
@section('title')
    ความเห็นของผู้บังคับบัญชาเหนือขึ้นไปอีกชั้นหนึ่ง
@endsection
        ...
        <div class="bg-white shadow-md rounded-lg overflow-hidden">
            <div class="bg-[#138f3c] text-white text-center py-3">
                @if ($evaluationRound == 1)
                    <h5 class="text-lg font-semibold">📋 ความเห็นของผู้บังคับบัญชาเหนือขึ้นไปอีกชั้นหนึ่ง รอบที่ ๑ ประจำปี
                        {{ $thaiNumbers }}</h5>
                @elseif($evaluationRound == 2)
                    <h5 class="text-lg font-semibold">📋 ความเห็นของผู้บังคับบัญชาเหนือขึ้นไปอีกชั้นหนึ่ง รอบที่ ๒ ประจำปี
                        {{ $thaiNumbers }}</h5>
                @endif
            </div>
                                ...
                                <tr class="border hover:bg-gray-100">
                                    ...
                                    <td class="px-4 py-2 border border-[#138f3c]">
                                        @switch($item->job_type_num)
                                            @case(1)
                                                <a href="{{ route('page.capacity_rate_it.further.create', $item->id) }}"
                                            ...
                                            @case(2)
                                                <a href="{{ route('page.capacity_rate_it.further.create_full_time_employee', $item->id) }}"
                                                    class="bg-[#138f3c] text-white px-3 py-1 rounded-md text-sm hover:bg-green-700">
                                                    <i class="bi bi-pencil-square"></i> ลงความเห็น
                                                </a>
                                            @break
                                            ...
                                            @case(3)
                                                <a href="{{ route('page.capacity_rate_it.further.create_general_government_employee', $item->id) }}"
                                                    class="bg-[#138f3c] text-white px-3 py-1 rounded-md text-sm hover:bg-green-700">
                                                    <i class="bi bi-pencil-square"></i> ลงความเห็น
                                                </a>
                                            @break
                                            ...
                                            @case(4)
                                                <a href="{{ route('page.capacity_rate_it.further.create_ministry_of_public_health_employee', $item->id) }}"
                                                    class="bg-[#138f3c] text-white px-3 py-1 rounded-md text-sm hover:bg-green-700">
                                                    <i class="bi bi-pencil-square"></i> ลงความเห็น
                                                </a>
                                            @break
                                            ...
                                            @case(5)
                                                <a href="{{ route('page.capacity_rate_it.further.create_temporary_employee', $item->id) }}"
                                                    class="bg-[#138f3c] text-white px-3 py-1 rounded-md text-sm hover:bg-green-700">
                                                    <i class="bi bi-pencil-square"></i> ลงความเห็น
                                                </a>
                                            @break
