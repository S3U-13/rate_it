        ...
        <div class="bg-white shadow-md rounded-lg overflow-hidden">
            <div class="bg-[#138f3c] text-white text-center py-3">
                @if ($evaluationRound == 1)
                    <h5 class="text-lg font-semibold">📋 หัวหน้าประเมินส่วนที่ ๑ รอบที่ ๑ ประจำปี
                        {{ $thaiNumbers }}</h5>
                @elseif($evaluationRound == 2)
                    <h5 class="text-lg font-semibold">📋 หัวหน้าประเมินส่วนที่ ๒ รอบที่ ๒ ประจำปี
                        {{ $thaiNumbers }}</h5>
                @endif
            </div>
                ...
                <table class="min-w-full border border-gray-300">
                    ...
                    <tbody class="text-center">
                        @if ($personals->isEmpty() && !$hasCompletedEvaluation)
                            <tr>
                                <td colspan="5" class="px-4 py-6 text-red-600 text-lg font-semibold border">
                            ...
                            @foreach ($personals as $item)
                                <tr class="border border-[#006622] hover:bg-gray-100">
                                    ...
                                    <td class="px-4 py-2 border">
                                        <a href="{{ route('page.capacity_rate_it.assessment_01.create', $item->id) }}"
