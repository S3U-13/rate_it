            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="pl-[3rem] pr-[3rem]">
                    <div class="px-4 md:px-16 lg:px-24 xl:px-32">
                        <h1 class="font-bold mt-6 text-xl text-center md:text-left">
                            เเบบสรุปการประเมินการปฏิบัติงานของลูกจ้างประจำ</h1>
                            ...
                            <div class="bg-gray-100 p-4">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <span
                                                class="text-gray-900 font-bold ml-2">{{ $personal->Tier->tier_name }}</span>
                                        </div>
                                    </div>
                                    <div>
                                        <div class="mb-2">
                                ...
                                <div class="flex flex-col md:flex-row md:justify-between">
                                    <div class="mb-2">
                                        ...
                                        <span
                                            class="text-gray-900 font-bold ml-2">{{ $personal->Group->group_name }}</span>
                                    </div>
                                    <div class="mb-2 pr-[15.2rem]">
                                        <h1 class="text-gray-600 inline">ค่าจ้าง (รายวัน):</h1>
                                        <span class="text-gray-900 font-bold ml-2">{{ $personal->wages }} บาท</span>
                                    </div>
                                </div>
                ...
                <div class="pl-[4rem] pr-[4rem]">
                    <div class="mt-2 rounded-lg overflow-hidden shadow-lg bg-[#138f3c]" x-data="{
                        rows: [{ current_responsibilities: '' }],
                        addRow() {
                            this.rows.push({ current_responsibilities: '' });
                        },
                        removeRow(index) {
                            ...
                            <thead>
                                <tr class="bg-[#138f3c] text-white">
                                    <th class="border-r w-[16rem] p-2 text-left pr-[4.5rem]">
                                        หน้าที่ความรับผิดชอบปัจจุบัน</th>
                                ...
                                <template x-for="(row, index) in rows" :key="index">
                                    <tr class="border-t">
                                        <td class="border-r bg-gray-100">
                                            <input type="text" name="current_responsibilities[]"
                                                class="pl-2 p-1 w-full bg-gray-100 h-[2.5rem]"
                                                x-model="row.current_responsibilities">
                                        </td>
                        ...
                        <!-- ปุ่มเพิ่มแถว -->
                        <div class="flex justify-end pr-[5rem] mb-2">
                ...
                <div class="pl-[4rem] pr-[4rem]">
                                    ...
                                    <tr class="border-t">
                                        ...
                                        <td class="border-r pl-2 text-center p-1">
                                            @php
                                                ...
                                                $points_multiply = $score
                                                    ? $score->points * $component->weight_score
                                                    : 0;
                                        ...
                                        <td class="border-r pl-2 text-center p-1">
                                            <input type="hidden" name="points_multiply[]"
                                                value="{{ $points_multiply }}">
                    ...
                    @php
                        ...
                        if ($total_point > 90) {
                            $selected_criterion =
                                $criterion_choice->where('criterion_name', 'ดีเด่น')->first()->id ?? null;
                        } elseif ($total_point > 80) {
                            $selected_criterion =
                                $criterion_choice->where('criterion_name', 'ดีมาก')->first()->id ?? null;
                        } elseif ($total_point > 70) {
                            $selected_criterion = $criterion_choice->where('criterion_name', 'ดี')->first()->id ?? null;
                        } elseif ($total_point > 60) {
                            $selected_criterion =
                                $criterion_choice->where('criterion_name', 'พอใช้')->first()->id ?? null;
                        } else {
                            $selected_criterion =
                ...
                <div class="pl-[4rem] pr-[4rem]">
                    <div class="mt-4">
                        <span class="font-bold">2.1 ความเห็นเกี่ยวกับการพัฒนาฝึกอบรม และการแก้ไขการปฏิบัติงาน</span>
                    </div>
                    <div class="mt-4 border rounded-lg p-2">
                        <p>(ระบุความถนัด จุดเด่น และสิ่งที่
                            ควรพัฒนาของผู้รับการประเมิน)</p>
                        <textarea class="w-full rounded-lg mt-2 h-30" name="evaluator_comment" id=""></textarea>
                    </div>

                    <div class="mt-4">
                        <span class="font-bold">2.2 ความเห็นเกี่ยวกับการเลื่อนขั้นค่าจ้าง</span>
                    </div>
                    @php
                        // หาเกณฑ์ที่ตรงกับคะแนน
                        if ($total_point > 90) {
                            $selected_wage_promotion =
                                $wage_promotion->where('wage_promotion_name', 'ควรเลื่อนขั้นค่าจ้าง 1 ขั้น')->first()
                                    ->id ?? null;
                        } elseif ($total_point > 60) {
                            $selected_wage_promotion =
                                $wage_promotion->where('wage_promotion_name', 'ควรเลื่อนขั้นค่าจ้าง 0.5 ขั้น')->first()
                                    ->id ?? null;
                        } elseif ($total_point < 60) {
                            $selected_wage_promotion =
                                $wage_promotion->where('wage_promotion_name', 'ไม่ควรเลื่อนขั้นค่าจ้าง')->first()->id ??
                                null;
                        }
                    @endphp
                    <div
                        class="grid grid-rows-1 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8 xl:gap-10 bg-gray-100 p-4 rounded-lg border border-gray-300 shadow-md mt-2">
                        @foreach ($wage_promotion as $wage)
                            <div class="flex items-center">
                                <input type="radio" name="wage_promotion_num" value="{{ $wage->id }}"
                                    {{ $selected_wage_promotion == $wage->id ? 'checked' : '' }}>
                                <span class="pl-2 text-gray-900 font-bold">{{ $wage->wage_promotion_name }}</span>
                            </div>
                        @endforeach
                    </div>
                    <div class="mt-4 border rounded-lg p-2">
                        <p>ระบุเหตุผลในการเสนอเลื่อนขั้นค่าจ้าง (โดยเฉพาะ
                            กรณีเสนอเลื่อนขั้นค่าจ้าง 1 ขั้น และกรณีเสนอไม่ควร
                            เลื่อนขั้นค่าจ้าง ให้ระบุให้ชัดเจน)</p>
                        <textarea class="w-full rounded-lg mt-2" name="wage_promotion_detail" id=""></textarea>
                    </div>
                    ...
                    @elseif($evaluationRound == 2)
                        <div
                            class="grid grid-rows-1 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8 xl:gap-10 bg-gray-100 p-4 rounded-lg border border-gray-300 shadow-md mt-2">
                            @foreach ($wage_promotion_1_5 as $wage_1_5)
                                <div class="flex items-center">
                                    <input type="checkbox" class="rounded-full" name="wage_promotion_num_1_5"
                                        value="{{ $wage_1_5->id }}">
                                    <span
                                        class="pl-2 text-gray-900 font-bold">{{ $wage_1_5->wage_promotion_1_5_name }}</span>
                                </div>
                            @endforeach
                        </div>
                        <div class="mt-4 border rounded-lg p-2">
                            <p>ตามระเบียบ
                                กระทรวงการคลังว่าด้วยการเลื่อนขั้นค่าจ้างลูกจ้างประจำ
                                ของส่วนราชการ พ.ศ. 2544 ข้อ 12 วรรคสาม เหตุผล
                                (ระบุว่าผลการประเมินดีเด่น เข้าเกณฑ์เลื่อนขั้นค่าจ้าง
                                1 ขั้น ในครั้งแรก แต่มีข้อจำกัดเรื่องโควตาและผล
                                ประเมินดีเด่นอีกในครั้งที่ 2 และโควตาให้เลื่อนขั้น
                                ค่าจ้างได้อย่างไรบ้าง)</p>
                            <textarea class="w-full rounded-lg mt-2" name="wage_promotion_detail_1_5" id=""></textarea>
                        </div>
                    @endif
                            ...
                            <div class="flex justify-end pr-6">
                                <div>
                                        ...
                                        <div x-data="{
                                            ...
                                            <div class="flex gap-2 items-center mt-2">
                                                ...
                                                <template x-if="signatureUrl">
                                                    <img :src="signatureUrl" alt="ลายเซ็น"
                                                        class="w-32 h-10 border p-1">
                                                </template>
                                                <button type="button" @click="showSignaturePad = true"
                                                    id="add_signature"
                                    ...
                                    <div class="">
                                        ...
                                        <input type="date" name="evaluation_date" class="rounded pl-4 p-1 mb-2"
                                            required>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="text-gray-900 border-gray-400 border rounded-lg overflow-hidden shadow-md">
                        ...
                        <div class="p-2 text-sm">
                            ...
                            <h1 class="pl-2"><span class="pr-6">ส่วนที่ ๒ </span><ins class="pr-2">
                                ...
                                องค์ประกอบด้านพฟติกรรมการปฏิบัติราชการเเละน้ำหนักของทั้งสององค์ประกอบ ในเเบบสรุปส่วนที่ ๒
                                นี้
