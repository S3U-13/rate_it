                ...
                <table class="min-w-full border border-gray-300">
                    <thead class="bg-[#138f3c] text-white text-center">
                        <tr>
                            ...
                            <th class="px-4 py-2 w-2/6 border">หมวด/แผนก</th>
                            <th class="px-4 py-2 w-1/6 border">การดำเนินการ</th>
                        </tr>
                    </thead>
                    ...
                    <tbody class="text-center">
                        ...
                        @elseif ($hasCompletedEvaluation)
                            @if ($evaluationRound == 1)
                                <tr>
                                    <td colspan="4" class="px-4 py-6 border">
                                ...
                                <tr class="border border-[#006622] hover:bg-gray-100">
                                    ...
                                    <td class="px-4 py-2 border border-[#006622]">
                                        @switch($item->job_type_num)
                                            @case(1)
                                                <a href="{{ route('page.capacity_rate_it.summarize.create', $item->id) }}"
                                                    class="bg-[#138f3c] text-white px-3 py-1 rounded-md text-sm hover:bg-green-700">
                                                    <i class="bi bi-pencil-square"></i> ส่งผลสรุป
                                                </a>
                                            @break

                                            @case(2)
                                                <a href="{{ route('page.capacity_rate_it.summarize.create_full_time_employee', $item->id) }}"
                                                    class="bg-[#138f3c] text-white px-3 py-1 rounded-md text-sm hover:bg-green-700">
                                                    <i class="bi bi-pencil-square"></i> ส่งผลสรุป
                                                </a>
                                            @break
                                            ...
                                            @case(3)
                                                <a href="{{ route('page.capacity_rate_it.summarize.create_general_government_employee', $item->id) }}"
                                                    class="bg-[#138f3c] text-white px-3 py-1 rounded-md text-sm hover:bg-green-700">
                                                    <i class="bi bi-pencil-square"></i> ส่งผลสรุป
                                                </a>
                                            @break
                                            ...
                                            @case(4)
                                                <a href="{{ route('page.capacity_rate_it.summarize.create_ministry_of_public_health_employee', $item->id) }}"
                                                    class="bg-[#138f3c] text-white px-3 py-1 rounded-md text-sm hover:bg-green-700">
                                                    <i class="bi bi-pencil-square"></i> ส่งผลสรุป
                                                </a>
                                            @break
                                            ...
                                            @case(5)
                                                <a href="{{ route('page.capacity_rate_it.summarize.create_temporary_employee', $item->id) }}"
                                                    class="bg-[#138f3c] text-white px-3 py-1 rounded-md text-sm hover:bg-green-700">
                                                    <i class="bi bi-pencil-square"></i> ส่งผลสรุป
                                                </a>
                                            @break
